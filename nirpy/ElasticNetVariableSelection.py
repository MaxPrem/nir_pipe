...
from sklearn.linear_model import ElasticNet, ElasticNetCV, MultiTaskElasticNet, MultiTaskElasticNetCV
from sklearn.metrics import mean_squared_error, r2_score
from sklearn.model_selection import cross_val_predict


class EnetSelect(TransformerMixin, RegressorMixin, BaseEstimator):
...
class MultitaskEnetSelect(TransformerMixin, RegressorMixin, BaseEstimator):
    """ .fit() performs crosscvalidation on ElasticNet model
     .transform() performs variable selection from sparse model
    """
    ...
    def fit(self, X, y):
        ...
        cv_model = MultiTaskElasticNetCV(
            l1_ratio=[0.01, 0.1, 0.5, 0.7, 0.9, 0.95, 0.99, 0.995, 1],
            eps=0.001,
            n_alphas=100,
            fit_intercept=True,
